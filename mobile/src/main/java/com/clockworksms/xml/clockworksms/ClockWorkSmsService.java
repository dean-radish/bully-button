package com.clockworksms.xml.clockworksms;

import com.clockworksms.xml.clockworksms.xml.CreditRequest;
import com.clockworksms.xml.clockworksms.xml.CreditResponse;
import com.clockworksms.xml.clockworksms.xml.MessageRequest;
import com.clockworksms.xml.clockworksms.xml.MessageResponse;
import com.clockworksms.xml.clockworksms.xml.SmsResponse;
import com.clockworksms.xml.clockworksms.xml.XMLMarshaller;
import com.clockworksms.xml.clockworksms.xml.XmlRequest;
import com.clockworksms.xml.clockworksms.xml.XmlResponse;
import com.clockworksms.xml.clockworksms.xml.xmlSMS;
...
public class ClockWorkSmsService {
	...
	private String version = "1.2.0"; // initial value. Actually read in from Manifest file
...
//		response1.setMessageId("ABC");
//		response1.setTo(messageRequest.getSms().get(0).getTo());
//		response1.setWrapperId(messageRequest.getSms().get(0).getWrapperId());
//		responses.add(response1);
//		messageResponse.setSmsResponses(responses);
		//DAD
...
//			marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
			...
			String requestString = marshaller.marshal(xmlRequest);

			String httpResponse = this.makeHttpRequest(urlAddress, requestString);
			...
			XmlResponse response = (XmlResponse) marshaller.unmarshal(httpResponse);
